...
const stackIcons: Record<string, { icon: LucideIcon; color: string }> = {
  ...
  "mercado livre api": { icon: ShoppingBag, color: "#f59e0b" },
  magalu: { icon: ShoppingBag, color: "#2563eb" },
  "rest apis": { icon: Code2, color: "#2563eb" },
  ...
  "alta volumetria": { icon: Database, color: "#0f766e" },
  "data warehouse": { icon: Database, color: "#0f766e" },
  "front-end": { icon: Code2, color: "#dc2626" },
  "html/css": { icon: Code2, color: "#e34f26" },
  javascript: { icon: Code2, color: "#d4a000" },
  "ui/ux": { icon: LayoutPanelTop, color: "#9333ea" },
  stability: { icon: ShieldCheck, color: "#059669" },
  produção: { icon: ShieldCheck, color: "#059669" },
  "bug fixing": { icon: ShieldCheck, color: "#dc2626" },
  "sienge erp": { icon: PackageCheck, color: "#2563eb" },
  ...
  integrações: { icon: Layers3, color: "#f97316" },
  "co-founder": { icon: Boxes, color: "#7c3aed" },
  "tech lead": { icon: Activity, color: "#7c3aed" },
  "e-commerce": { icon: ShoppingBag, color: "#f97316" },
  escala: { icon: Activity, color: "#7c3aed" },
  "ambiente enterprise": { icon: ShieldCheck, color: "#475569" },
  "erp consistem": { icon: PackageCheck, color: "#475569" },
  plm: { icon: PackageCheck, color: "#2563eb" },
  "app mobile": { icon: Smartphone, color: "#2563eb" },
  workers: { icon: Activity, color: "#2563eb" },
  "multi-tenant": { icon: Boxes, color: "#7c3aed" },
  mentoria: { icon: Activity, color: "#f97316" },
  "ia aplicada": { icon: Layers3, color: "#f97316" },
};
...
const stackLogos: Record<string, StackLogo> = {
  ...
  "power bi": { src: "/stack/powerbi.svg", alt: "Power BI", color: "#f2c811" },
  "power automate": { src: "/stack/powerautomate.svg", alt: "Power Automate", color: "#0066ff" },
  qlikview: { src: "/stack/qlik.svg", alt: "Qlik", color: "#009848" },
};
